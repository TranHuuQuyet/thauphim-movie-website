...
<main class="page-shell" id="home" aria-label="Nội dung chính">
    ...
    <section class="genre-section" id="hot-genres" aria-labelledby="hot-genres-title">
        <div class="section-head">
            ...
            <a href="#hot-genres" class="view-more">Xem thêm</a>
        </div>
        ...
        <div class="genre-grid" id="hotGenres">
            ...
            <a class="genre-card" href="#featured" data-genre-id="35">
                <i class="fa-solid fa-face-laugh" aria-hidden="true"></i>
                <span>Hài</span>
            </a>
            <a class="genre-card" href="#featured" data-genre-id="18">
                <i class="fa-solid fa-clapperboard" aria-hidden="true"></i>
                <span>Tâm lý</span>
            </a>
            <a class="genre-card" href="#featured" data-genre-id="27">
                <i class="fa-solid fa-ghost" aria-hidden="true"></i>
                <span>Kinh dị</span>
            </a>
            <a class="genre-card" href="#featured" data-genre-id="16">
                <i class="fa-solid fa-wand-magic-sparkles" aria-hidden="true"></i>
                <span>Hoạt hình</span>
            </a>
            <a class="genre-card" href="#featured" data-genre-id="878">

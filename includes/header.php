...
<head>
    ...
    <link rel="icon" type="image/png" sizes="512x512"
        href="<?= htmlspecialchars(app_url('assets/images/favicon-tab.png'), ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <details class="nav-dropdown<?= $isCountryActive ? ' is-active' : '' ?>">
                        ...
                        <div class="nav-dropdown-menu">
                            <?php foreach ($tmdbCountries as $country): ?>
                                <a
                                    href="<?= htmlspecialchars(app_url('pages/country.php?code=' . urlencode($country['code'])), ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <button id="notificationToggle" class="notification-toggle" type="button"
                            ...
                            <?php if ($isMember && $notificationUnreadCount > 0): ?>
                                <span class="notification-badge"
                                    aria-label="<?= $notificationUnreadCount ?> thông báo chưa đọc" data-notification-badge>
                        ...
                        <div class="account-wrapper" data-account-root>
                            ...
                            <div class="account-panel" id="accountPanel" role="menu" aria-label="Tài khoản" hidden
                                ...
                                <a class="account-menu-item"
                                    href="<?= htmlspecialchars(app_url('pages/account.php'), ENT_QUOTES, 'UTF-8') ?>"
                                    role="menuitem">
                                    <i class="fa-solid fa-user" aria-hidden="true"></i>
                                    <span>Tài khoản</span>
                                </a>
                                <a class="account-menu-item"
                                    href="<?= htmlspecialchars(app_url('pages/account.php?tab=favorites'), ENT_QUOTES, 'UTF-8') ?>"
                                    role="menuitem">
                                    <i class="fa-solid fa-heart" aria-hidden="true"></i>
                                    <span>Phim yêu thích</span>
                                </a>
                                <a class="account-menu-item"
                                    href="<?= htmlspecialchars(app_url('pages/account.php?tab=history'), ENT_QUOTES, 'UTF-8') ?>"
                                    role="menuitem">
                                    <i class="fa-solid fa-clock-rotate-left" aria-hidden="true"></i>
                                    <span>Lịch sử xem</span>
                                </a>
                                <a class="account-menu-item account-menu-item--logout"
                                    href="<?= htmlspecialchars(app_url('logout.php'), ENT_QUOTES, 'UTF-8') ?>"
                                    role="menuitem">
